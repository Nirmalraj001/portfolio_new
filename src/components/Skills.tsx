...
import { Code2, Database, Layout, Terminal, TestTube, PenTool as Tool } from 'lucide-react';
  ...
  const skillCategories = [
    {
      ...
      skills: ['JavaScript (ES6+)', 'TypeScript', 'React.js', 'HTML5', 'CSS3', 'Sass'],
    ...
    },
    {
      ...
      skills: ['Node.js', 'Express.js', 'Docker', 'Git'],
      color: 'from-purple-500 to-pink-500',
    },
    {
      title: 'UI Frameworks',
      icon: <Code2 className="w-6 h-6" />,
      skills: ['Material-UI', 'Tailwind CSS', 'Shadcn/UI', 'Bootstrap'],
